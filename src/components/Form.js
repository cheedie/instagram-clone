  ...
  return (
    <Wrapper>
      ...
      <FormWrapper>
        <legend>
          <InputWrapper>
            <Label className = {phone | email ? "active" : ""} htmlFor={check || "phone"}>
          ...
          <InputWrapper>
            <Label className = {name ? "active" : ""} htmlFor="name"> Fullname </Label>
            <Input
              name="name"
              type="text"
              value={name}
          ...
          <InputWrapper>
            <Label className = {username ? "active" : ""} htmlFor="username"> Username </Label>
            <Input
              name="username"
              type="text"
              value={username}
          ...
          <InputWrapper>
            <Label className = {password ? "active" : ""} htmlFor="password"> Password </Label>
            <Input
              name="password"
              type="password"
              value={password}
